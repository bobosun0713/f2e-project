...
export default defineComponent({
  ...
  render() {
    return (
      <section class="eighth-screen z-[10] w-full h-screen fixed top-0 left-0 hidden opacity-0">
        <img
          class="eighth-screen-bg absolute top-1/2 left-[-10%] w-[30%] scale-[1]"
          src={getImage('other/bg_decorate_cloud_01.svg')}
          alt="bg_decorate_cloud_01"
        />
        <img
          class="eighth-screen-bg absolute top-1/2 right-[-10%] w-[30%] scale-[1]"
          src={getImage('other/bg_decorate_cloud_02.svg')}
          alt="bg_decorate_cloud_02"
        />
        <img
          class="eighth-screen-bg absolute top-0 left-1/2 translate-x-[-50%] scale-[2] w-[75%] hidden opacity-0"
